    ...
    return (
        ...
        <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <div className="flex items-center justify-between">
                <Link href="/importar-ventas" >
                <Button variant="outline" className="bg-transparent hover:bg-green-700 text-green-700 font-semibold hover:text-white py-2 px-4 border border-green-500 hover:border-transparent rounded">
                    ...
                    <TableBody>
                        {ventas.length ?
                            ...
                            <TableRow key={mov.id}>
                                ...
                                <TableCell className="text-center">{formatoMoneda.format(mov.venta_total)}</TableCell>
                                ...
                                <TableCell className="text-center">{formatoMoneda.format(mov.utili_total)}</TableCell>
