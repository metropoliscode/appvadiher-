                                ...
                                <TableCell className="text-right">
                                    <Table>
                                        <TableHeader>
                                            ...
                                            <TableRow>
                                                <TableCell className={((mov.utilid_metropolis / mov.venta_metropolis) * 100) > 25 ? 'text-green-900' : 'text-red-900' }>{mov.venta_metropolis == 0 ? '0.00 %' : `${((mov.utilid_metropolis / mov.venta_metropolis) * 100).toFixed(2)} %`}</TableCell>
                                            </TableRow>
                                        </TableHeader>
                                    </Table>
                                </TableCell>
                                <TableCell className="text-right">
                                    <Table>
                                        <TableHeader>
                                            ...
                                            <TableRow>
                                                <TableCell className={((mov.utilid_distrimetro / mov.venta_distrimetro) * 100) > 25 ? 'text-green-900' : 'text-red-900' }>{mov.venta_distrimetro == 0 ? '0.00 %' : `${((mov.utilid_distrimetro / mov.venta_distrimetro) * 100).toFixed(2)} %`}</TableCell>
                                            </TableRow>
                                        </TableHeader>
                                    </Table>
                                </TableCell>
                                <TableCell className="text-right">
                                    <Table>
                                        <TableHeader>
                                            ...
                                            <TableRow>
                                                <TableCell className={((mov.utilid_ferrecasas / mov.venta_ferrecasas) * 100) > 25 ? 'text-green-900' : 'text-red-900' }>{mov.venta_ferrecasas == 0 ? '0.00 %' : `${((mov.utilid_ferrecasas / mov.venta_ferrecasas) * 100).toFixed(2)} %`}</TableCell>
                                            </TableRow>
                                        </TableHeader>
                                    </Table>
                                </TableCell>
                                <TableCell className="text-right">
                                    <Table>
                                        <TableHeader>
                                            ...
                                            <TableRow>
                                                <TableCell className={((mov.utilid_troncal / mov.venta_troncal) * 100) > 25 ? 'text-green-900' : 'text-red-900' }>{mov.venta_troncal == 0 ? '0.00 %' : `${((mov.utilid_troncal / mov.venta_troncal) * 100).toFixed(2)} %`}</TableCell>
                                            </TableRow>
                                        </TableHeader>
                                    </Table>
                                </TableCell>
                                <TableCell className="text-right">
                                    <Table>
                                        <TableHeader>
                                            ...
                                            <TableRow>
                                                <TableCell className={((mov.utilid_minca / mov.venta_minca) * 100) > 25 ? 'text-green-900' : 'text-red-900' }>{mov.venta_minca == 0 ? '0.00 %' : `${((mov.utilid_minca / mov.venta_minca) * 100).toFixed(2)} %`}</TableCell>
                                            </TableRow>
                                        </TableHeader>
                                    </Table>
                                </TableCell>
                                <TableCell className="text-right">
                                    <Table>
                                        <TableHeader>
                                            ...
                                            <TableRow>
                                                <TableCell className={((mov.utili / mov.venta) * 100) > 25 ? 'text-green-900' : 'text-red-900' }>{mov.venta == 0 ? '0.00 %' : `${((mov.utili / mov.venta) * 100).toFixed(2)} %`}</TableCell>
                                            </TableRow>
                                        </TableHeader>
                                    </Table>
                                </TableCell>
